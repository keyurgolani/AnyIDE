...
from src.tools.http_tools import DomainBlockedError, SSRFError
from src.tools.memory_tools import NodeNotFoundError
from src.tools.plan_tools import PlanNotFoundError, PlanValidationError
from src.workspace import SecurityError, WorkspaceManager
...
async def websocket_logs(websocket: WebSocket):
    ...
    await websocket.accept()
    from src.admin_api import decrement_ws_connections, increment_ws_connections
